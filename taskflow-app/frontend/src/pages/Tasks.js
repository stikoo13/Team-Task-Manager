...
export default function Tasks() {
  ...
  // For members: group tasks by project for sidebar-like project tabs
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: t.bg, fontFamily: "'DM Sans', sans-serif", transition: 'background 0.3s' }}>
      ...
      <main style={{ flex: 1, display: 'flex', overflowY: 'auto' }}>
        ...
        {isMember && (
          <div style={{
            width: '200px', flexShrink: 0, borderRight: `1px solid ${t.border}`,
            padding: '32px 12px', background: t.cardBg
          }}>
