...
exports.login = async (req, res) => {
  try {
    ...
    // Verify role matches what user selected on login screen
    if (role && user.role !== role) {
      return res.status(401).json({ message: `This account is not registered as ${role}. Please select the correct role.` });
    }
